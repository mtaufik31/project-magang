...
<body>
    ...
    {{-- navbar bawah --}}
    <nav class="bg-accent bg-[rgb(255,153,0,0.7)] hidden md:block ">
        <div class="max-w-screen-xl px-5 py-3 mx-auto">
            <div class="flex font-inter items-center justify-between">
                <ul class="flex flex-row font-fira mt-0 space-x-10 rtl:space-x-reverse text-lg  ">
                    <li>
                        <a href="#" class="text-gray-900 group justify-center">
                            Home
                            <hr
                ...
                <div class="flex space-x-4 ml-auto">
                    <button type="button"
                        class=" bg-[#FE9800] hover:bg-[rgb(255,153,0,0.7)] duration-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2 text-center ">
                        Login
                    </button>
                    <button type="button"
                        class=" bg-[#FE9800] hover:bg-[rgb(255,153,0,0.7)] duration-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center">
                        Register
                    </button>
                </div>
            </div>
    ...
    <footer class="bg-[rgb(255,153,0,0.7)] pt-16 pb-12">
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full px-4 md:ps-32 mb-12 text-black font-medium md:w-1/3">
                    <h2 class="font-light  text-4xl text-black mb-5">MangaLo!</h2>
                    <a href="#">
                        <H3 class="font-bold text-2xl mb-5 underline hover:text-orange-500  duration-200">Hubungi Kami</H3>
                    </a>
                    <p class="mb-4">mangaLoCompany@gmail.com</p>
                    <p class="">Jl. HR. Soebrantas</p>
                    <p>Sidomulyo Baru, Kec. Tampan, Kota Pekanbaru, Riau 28293</p>
                </div>
                <div class="w-full px-6 mb-12  md:w-1/3">
