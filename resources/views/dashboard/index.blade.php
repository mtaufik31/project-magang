...
@section('content')
    <div class="flex gap-4">
        <div class="bg-blue-400 text-white rounded-lg w-1/4 shadow-lg p-4">
        ...
        <div class="bg-red-400 text-white rounded-lg w-1/4 shadow-lg p-4">
            <div class="flex items-center justify-between">
                <div class="text-4xl font-bold">7</div>
        ...
        <div class="bg-yellow-400 text-white rounded-lg w-1/4 shadow-lg p-4">
            <div class="flex items-center justify-between">
                <div class="text-4xl font-bold">7</div>
        ...
        <div class="bg-green-400 text-white rounded-lg w-1/4 shadow-lg p-4">
            <div class="flex items-center justify-between">
