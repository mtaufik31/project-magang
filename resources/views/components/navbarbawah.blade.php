    ...
    <div class="max-w-screen-xl px-5 mx-auto ">
        <div class="flex font-inter items-center justify-between">
            <ul class="flex flex-row font-fira mt-0 gap-10 rtl:space-x-reverse text-lg items-center ">
                <li>
                    <a href="{{ route('home') }}"
                        class="text-gray-900 flex flex-col items-center group justify-center {{ request()->routeIs('home') ? 'bg-[#ff9900] px-4 py-3 text-white  rounded-lg' : '' }} {{ request()->routeIs('search.manga') ? 'bg-[#ff9900] px-4 py-3 text-white  rounded-lg' : '' }} {{ request()->routeIs('coins.topup') ? 'bg-[#ff9900] px-4 py-3 text-white  rounded-lg' : '' }} {{ request()->routeIs('process.topup') ? 'bg-[#ff9900] px-4 py-3 text-white  rounded-lg' : '' }} ">
                        Home
                        <hr
                ...
                <li>
                    <a href="{{ route('list') }}"
                        class="text-gray-900 group justify-center flex flex-col items-center {{ request()->routeIs('list') ? 'bg-[#ff9900] px-4 py-3 text-white  rounded-lg' : '' }} {{ request()->routeIs('manga') ? 'bg-[#ff9900] px-4 py-3 text-white  rounded-lg' : '' }} {{ request()->routeIs('genre.sort') ? 'bg-[#ff9900] px-4 py-3 text-white  rounded-lg' : '' }} {{ request()->routeIs('chapter') ? 'bg-[#ff9900] px-4 py-3 text-white  rounded-lg' : '' }} ">
                        List
                        <hr
                            class="w-0 border-transparent transition-all duration-300 group-hover:w-full group-hover:border-black">
                    </a>
                ...
                <li>
                    <a href="{{ route('faq') }}"
                        class="text-gray-900 group justify-center flex flex-col items-center {{ request()->routeIs('faq') ? 'bg-[#ff9900] px-4 py-3 text-white rounded-lg' : '' }}">
                        FAQ
                        <hr
                            class="w-0 border-transparent transition-all duration-300 group-hover:w-full group-hover:border-black">
