    ...
    <div class="max-w-screen-xl px-5 mx-auto ">
        <div class="flex font-inter items-center justify-between">
            <ul class="flex flex-row font-fira mt-0 gap-10 rtl:space-x-reverse text-lg items-center ">
                <li>
                    <a href="{{ route('home') }}"
                        class="text-gray-900 flex flex-col items-center group justify-center {{ request()->routeIs('home') ? 'bg-[#ff9900] px-4 py-3 text-white  rounded-lg' : '' }} {{ request()->routeIs('search.manga') ? 'bg-[#ff9900] px-4 py-3 text-white  rounded-lg' : '' }} {{ request()->routeIs('points') ? 'bg-[#ff9900] px-4 py-3 text-white  rounded-lg' : '' }} ">
                        Home
                        <hr
