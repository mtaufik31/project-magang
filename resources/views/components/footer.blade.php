    ...
    <div class="container">
        <div class="flex flex-wrap">
            <div class="w-full px-4 lg:ps-48 mb-12 md:me-24 text-black font-lg md:w-1/3">
                ...
                <a href="#">
                    <H5 class="font-bold text-[20px] mb-3 underline hover:text-orange-500  duration-200">Hubungi Kami
                    </H5>
                </a>
            ...
            <div class="w-full px-5 mb-12  md:w-1/3">
                ...
                <ul class="text-black">
                    ...
                    <li>
                        <a href="{{ route('blogs') }}"
                            class="inline-block text-base hover:text-orange-500 mb-3">Blogs</a>
                    </li>
                    <li>
                        <a href="{{ route('join') }}" class="inline-block text-base hover:text-orange-500 mb-3">Join
                            Us</a>
                    </li>
                    <li>
        ...
        <div class="w-full pt-7 border-t border-slate-800">
            <div class="flex items-center justify-center mb-5">
                ...
                <a href="https://www.youtube.com/channel/UCKuxmNI6Di5DMT6f8CedeDA" target="_blank"
                    ...
                    <svg role="img" fill="black" width="20" class="fill-black group-hover:fill-red-600"
                ...
                <a href="https://instagram.com/mtaufikbudiman_" target="_blank"
                    ...
                    <svg role="img" fill="black" width="20" class="fill-curre group-hover:fill-pink-700"
                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://osu.ppy.sh/users/34234551" target="_blank"
                    class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-black group hover:border-white">
                    <svg role="img" fill="black" width="20" class="fill-curre group-hover:fill-pink-500"
                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <title>osu!</title>
                        <path
            ...
            <p class="font-medium text-xs text-slate-500 text-center">
                Make with ❤️ by
                <a href="https://instagram.com/muhammadtaufkb_" class="font-bold text-primary">Muhammad Taufik
                    B. 😎
                </a>
            </p>
        </div>
