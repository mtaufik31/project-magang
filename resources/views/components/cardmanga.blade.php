<a href="{{ route('manga', $id) }}" class="block text-center font-fira">
    <div class="w-[140px] h-[230px] mx-auto relative group rounded-b-md box-manga mb-1">
        ...
        <img class="relative object-cover w-full h-full transition-shadow duration-300 rounded-md shadow-none cursor-pointer z-[1] hover:shadow-lg hover:shadow-gray-500" src="{{ $image }}"
            alt="Jujutsu Kaisen">
