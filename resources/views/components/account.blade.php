<div x-data="{ isOpen: false }" class="relative text-left md:px-5">
    <div>
        <button type="button" @click="isOpen = !isOpen"
            class="inline-flex w-full justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-semibold bg-[#ff9900] text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300"
