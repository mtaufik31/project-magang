<div x-data="{ isOpen: false }" class="relative text-left md:px-5">
    <div>
        <button type="button" @click="isOpen = !isOpen"
            class="inline-flex w-full self-center justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-semibold bg-[#FF9900]  text-gray-900  "
            id="menu-button" aria-expanded="true" aria-haspopup="true"> <i class="fa-solid fa-circle-user self-center text-2xl hover:text-white"></i>
            @if (Auth::check())
